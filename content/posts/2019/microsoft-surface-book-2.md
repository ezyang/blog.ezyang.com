...
date: 2019-03-17 21:59:52
slug: microsoft-surface-book-2
categories: [Toolbox]
comments:
    - id: 22694
      author: Anonymous
      date: "2019-03-18 06:10:41"
      content: |
        &gt; Rewrite Xournal with support for hDPI (how hard could it be lol)
        
        Have you checked if the xournal++ fork would satisfy this? It looks like it should be working as of very recently (https://github.com/xournalpp/xournalpp/pull/759) — though apparently there are problematic edge cases: https://github.com/xournalpp/xournalpp/issues/897
    - id: 22695
      author: Jan
      date: "2019-03-18 08:46:00"
      content: "What do you think about the modernized https://github.com/xournalpp/xournalpp?"
    - id: 22696
      author: Edward Z. Yang
      date: "2019-03-18 09:52:14"
      content: "I'm aware of xournalpp, but I'm running some custom patches on my Xournal fork which I'd have to port to xournalpp... so I haven't gotten around to doing it yet ;)"
    - id: 22698
      author: Ridwan
      date: "2019-03-18 14:09:25"
      content: "Did you manage to get hibernation working with touch screen enabled? Doesn't the system crash eventually after resuming from hibernation?"
    - id: 22699
      author: Edward Z. Yang
      date: "2019-03-18 14:17:50"
      content: "I would find that my system would sometimes fail to resume from hibernate, but after successfully getting out of hibernation it would not crash afterwards. I haven't used the touch screen heavily so I am not sure if it every stops working after hibernate."
    - id: 22704
      author: Edward Kmett
      date: "2019-03-18 23:45:53"
      content: |
        This is pretty much why my windows laptop remains a "windows laptop" and I just use WSL to do most of the things I want to do on it. I start up VcXsrv, run terminator so I don't have to have anything to do with the windows console emulation crap and am off to the races modulo some headaches with VSCode.
        
        Running Linux in a VM was a nonstarter for me as well, simply because you have to figure out how much to cripple the host vs the hosted OS when it comes to allocating cores. 
        
        One plus of the WSL solution is that you don't have to make this sort of trade-off. Everything just runs full speed. 
        
        One minus is that full speed isn't as fast as a native linux install when the application is doing a lot of fiddling with files, because Windows doesn't cache attributes as well as Linux.
    - id: 22717
      author: Edward Z. Yang
      date: "2019-03-19 23:00:41"
      content: "Edward Kmett: I seriously, seriously considered it. But at this point Xournal is too important to my professional life for me to give it up XD  Also, failure to cache metadata on Windows filesystems really is a dealbreaker in my experience; it really makes a lot programs (like Git) way slower."
    - id: 22725
      author: Xdxdxd
      date: "2019-03-21 07:55:41"
      content: |
        About that:
        
        (Updated on March 19, 2019) Suspend is really slow. Although jakeday's setup.sh suggests that suspend is not working, something is working, in the sense that if I close my laptop lid, the laptop goes into a low power state of some sort. But it takes quite a long time to suspend, an even longer time to restart, and you still have to click past the bootloader (which makes me seriously wonder if we are actually suspending).
        
        Sounds like you said 'yes' to Jakeday's script question to replace suspend with hibernate. It now hibernates when you click suspend
    - id: 22726
      author: Sean
      date: "2019-03-21 10:59:38"
      content: "I just installed 8.10 on a SP4 the other day and after failing to get hibernation to work (apparently because I had no swap partition) I ended up reinstalling Ubuntu and saying \"no\" to the jakeday script when asked to replace hibernation with suspend, and surprisingly, suspend seems to work fine for me! WiFi even comes back when I come out of suspend. It might be worth trying suspend instead of hibernate if you haven't yet."
    - id: 22997
      author: Anonymous
      date: "2019-09-13 10:44:30"
      content: "Fedora, which uses native Gnome, actually has a really good touch gesture, pen support and HiDPI support... you should give that a try"
    - id: 23290
      author: Alberto
      date: "2019-12-11 10:56:09"
      content: |
        What do you mean here? I dont remember having to use this command.
        
        ``One consequence of generating signed kernels, is that if you have both the unsigned and signed kernels installed update-initramfs -u ``
---
