---
title: "Width-adaptive XMonad layout"
date: 2015-05-02 00:36:55
slug: width-adaptive-xmonad-layout
categories: [Haskell, Toolbox]
comments:
    - id: 13796
      author: Brent Yorgey
      date: "2015-05-02 11:03:18"
      content: "Looks cool!  I could actually use this. The patch submission process is simple: just send a darcs patch to the mailing list. I'll take a look at it once you do."
    - id: 16906
      author: Steffen Schuldenzucker
      date: "2015-09-13 08:24:33"
      content: |
        Nice! Using this as a starting point to react dynamically to pivoting and left/right screens.
        Btw. your blog seems to cut off code starting at some width. It's still possible to copy'n'paste, though. I made a gist for convenience (also comes with syntax highlighting): https://gist.github.com/sschuldenzucker/e3d73f28e5185850244a
---
