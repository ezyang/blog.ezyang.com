---
title: "Of Monadic Fixpoints and Heap Offsets"
date: 2013-09-24 22:20:57
slug: of-monadic-fixpoints-and-heap-offsets
categories: [GHC]
comments:
    - id: 6258
      author: Jan Stolarek
      date: "2013-10-06 10:10:28"
      content: "Nice post - one more piece of a puzzle of how heap checks and stack checks are generated by GHC. I still have a few lose ends from my MSR internship and most of them are about investigating stack checks and heap checks."
    - id: 6261
      author: Jan Stolarek
      date: "2013-10-07 04:15:26"
      content: "After a moments thought, I don't understand why you call that construction a \"monadic fixpoint\". Could you explain that? To me this is a mutual recursion, a bit similar to \"backwards state monad\" presented by Wadler in \"The essence of functional programming\". A true monadic fixpoint (the \"mfix\" function) can be found for example in cmmLayoutStack function in CmmLayoutStack module."
    - id: 6262
      author: Edward Z. Yang
      date: "2013-10-07 04:53:30"
      content: "Hm, I think you're right, it is \"monadic\" and it is a \"fixpoint\", but it is not a \"monadic fixpoint\"."
---
