---
title: "The duality of weak maps and private symbols"
date: 2013-03-19 00:12:16
slug: duality-of-weak-maps-and-private-symbols
categories: [Programming Languages]
comments:
    - id: 5981
      author: "Sam Tobin-Hochstadt"
      date: "2013-03-19 10:43:54"
      content: |
        It's worth noting that, as you probably noticed, other people in the room would quibble with some of these statements.
        
        First, the statement about performance is only based on reasoning about GC behavior, which is of course not the only performance consideration.
        
        Second, the fact that two features are inter-expressive is only sometimes a reason to think that only one is needed.  The duality of objects and closures is well-known, but many languages (including JS) have both, and with good reason.  This isn't really about complexity of JS, but about separation of distinct concepts.
        
        Finally, just for clarity because I expect you know this, the relationship between "soft" and "hard" fields of objects is a long-known fact about languages -- it just happens that WeakMaps and Symbols are how this manifests in JS.
    - id: 5982
      author: Edward Z. Yang
      date: "2013-03-21 04:33:10"
      content: "All good points. It's not surprising to me that the soft/hard relationship is well known, although I can't put my finger on where it shows up in the literature."
---
