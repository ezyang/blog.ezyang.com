---
title: "When a lock is better than an MVar"
date: 2014-01-07 18:47:26
slug: when-a-lock-is-better-than-an-mvar
categories: [GHC]
comments:
    - id: 6346
      author: John Lato
      date: "2014-01-09 01:23:08"
      content: "I found some old blog references to exploring transactional boosting to improve STM performance (e.g. http://ghcmutterings.wordpress.com/2008/11/14/comparing-concurrent-linked-list-implementations-in-haskell/ ).  Do you know if anyone ever did any work on this?  That post seems to indicate we'd just need support for adding actions to run at transaction commit/abort, which is something I've wanted anyway."
    - id: 6347
      author: Edward Z. Yang
      date: "2014-01-09 01:26:13"
      content: "I am unaware of anyone doing this for GHC's STM implementation, so, still a good task for a budding GHC hacker. Sulzmann, who was coauthor on the paper, also wrote some posts on the subject: http://sulzmann.blogspot.com/2008/11/transactional-boosting.html (however, he was a little confused about transactional boosting needing pessimistic concurrency; this is only half right.)"
    - id: 6348
      author: carter
      date: "2014-01-09 01:47:17"
      content: "the link about transactional boosting is dead, heres a valid one http://cs.nyu.edu/~ejk/papers/boosting-ppopp08.pdf"
---
