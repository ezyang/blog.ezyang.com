---
title: "Seize the Means of Production (of APIs)"
date: 2016-09-13 01:09:52
slug: seize-the-means-of-production-of-apis
categories: [Software Engineering]
---

There's a shitty API and it's ruining your day. What do you do?

- Maybe you're Dropbox: Apple's privileges API isn't giving you the knobs you need, so you're like, "Fuck this, we're going to [edit the privileges SQL database directly](https://news.ycombinator.com/item?id=12463338)."
- Maybe you're Adam Belay: POSIX isn't letting you write high performance networking code, so you're like "Fuck this, we're going to [redesign the operating system to support high throughput applications](https://www.usenix.org/system/files/conference/osdi14/osdi14-paper-belay.pdf)."
