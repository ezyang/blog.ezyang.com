---
title: "A tale of backwards compatibility in ASTs"
date: 2016-12-31 23:35:33
slug: a-tale-of-backwards-compatibility-in-asts
categories: [Haskell]
comments:
    - id: 21751
      author: EECOLOR
      date: "2017-01-01 06:05:07"
      content: "Maybe this will help you: https://www.youtube.com/watch?v=oyLBGkS5ICk"
    - id: 21752
      author: EECOLOR
      date: "2017-01-01 06:22:33"
      content: "Is it by design that the comment section is not visible?"
    - id: 21755
      author: EECOLOR
      date: "2017-01-01 06:25:23"
      content: |
        Ok, it seems that if I post a comment with a link to youtube, it will not show up...
        
        Search for: Spec-ulation Keynote - Rich Hickey
    - id: 21757
      author: Edward Z. Yang
      date: "2017-01-01 11:47:32"
      content: |
        Hi EECOLOR, my blog is set to automoderate any comments with links, which is why your link didn't show up. It's through now!
        
        I am well aware of this keynote, having written a post about it: http://blog.ezyang.com/2016/12/thoughts-about-spec-ulation-rich-hickey/ But it requires more investigation to figure out why this sort of situation doesn't show up in Clojure (it's not obvious from the talk.)
    - id: 21756
      author: MPG
      date: "2017-01-01 09:00:57"
      content: "Could this have been avoided wit the forthcoming extendable data types extension?"
    - id: 21758
      author: Edward Z. Yang
      date: "2017-01-01 11:49:16"
      content: "MPG: Which extensible data types proposal are you referring to?"
    - id: 21802
      author: Sergey Vinokurov
      date: "2017-01-29 05:04:13"
      content: "It seems that type signature of `targetBuildDepends` from approach 2 is completely wrong. For instance, given that `targetBuildDepends2 :: BuildInfo -&gt; [BuildDependency]`, the `targetBuildDepends` should be consuming values of `BuildInfo` type, not producing them."
    - id: 21806
      author: Edward Z. Yang
      date: "2017-02-03 19:51:46"
      content: "Sergey: Yes, you are right! I've fixed it."
    - id: 21860
      author: Wizek
      date: "2017-03-07 22:20:20"
      content: "Fascinating read, thanks for sharing!"
    - id: 35671
      author: AI math solver
      date: "2025-06-17 14:16:30"
      content: "Interesting take on backwards compatibility in ASTs! Food for thought."
---
