---
title: "Try Backpack: <code>ghc --backpack</code>"
date: 2016-10-10 04:39:14
slug: try-backpack-ghc-backpack
categories: [Backpack]
comments:
    - id: 21397
      author: Luke Palmer
      date: "2016-10-10 05:26:03"
      content: "WOW this is exciting!  I had no idea something like this was in the works!  Signatures have been among my top wishes when I'm working in Haskell -- a number of times I've gone to great lengths to emulate them with typeclasses (which is pretty painful).  I assume you wrote it?  Thank you!"
    - id: 21399
      author: Joachim Breitner
      date: "2016-10-10 10:28:00"
      content: "Great concise intro. I’m curious in what ways the people out there will (ab)use your work! :-)"
    - id: 21569
      author: Anonymous
      date: "2016-11-14 10:53:33"
      content: |
        Nice. I actually went through it step-by-step. 
        
        1.  `dependency regex-indef[Str=bytestring-string:Str]` is incorrect and leads to panic:
        
        ```
        [4 of 4] Processing main
        ghc: panic! (the 'impossible' happened)
          (GHC version 8.1.20161023 for x86_64-unknown-linux):
        	no package name
        CallStack (from HasCallStack):
          error, called at compiler/backpack/DriverBkp.hs:545:32 in ghc:DriverBkp
        
        Please report this as a GHC bug:  http://www.haskell.org/ghc/reportabug
        ```
        
        It should be `dependency regex-indef[Str=str-bytestring:Str]`
        
        2. Where should the `{-# LANGUAGE OverloadedStrings #-}` go? I added it to the top of the file and it worked but it should go under Main like this:
        ...
        ```
        That does not work, I am getting 
        
        ```
          [1 of 1] Compiling Main             ( main/Main.hs, main/Main.o )
        
        tutorial.bkp:78:37: error:
            • Couldn't match type ‘[Char]’
                             with ‘Data.ByteString.Internal.ByteString’
              Expected type: str-bytestring:Str.Str
                Actual type: [Char]
            • In the second argument of ‘accept’, namely ‘"acc"’
              In the first argument of ‘print’, namely ‘(accept evencs "acc")’
              In the expression: print (accept evencs "acc")
        ```
    - id: 21586
      author: Edward Z. Yang
      date: "2016-11-18 16:19:04"
      content: |
        Hi Anonymous,
        
        Sorry about the late response, and thanks for trying it out! I fixed (1), re (2) the bkp format unfortunately doesn't currently support language pragmas per-module; it was annoyingly difficult to implement and since bkp files aren't a real thing anyway, I ditched them. Just put it at the top.
---
