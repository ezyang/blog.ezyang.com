---
title: "What happens when you mix three research programming languages together"
date: 2012-05-16 02:54:22
slug: what-happens-when-you-mix-three-research-programming-languages-together
categories: [Academia, Computer Science]
comments:
    - id: 3735
      author: Anonymous
      date: "2012-05-16 04:29:30"
      content: |
        "However, because functions which manipulate C pointers are non-transactional, Ur/Web is limited to FFI functions which handle basic C types, e.g. integers and strings. Thus the question of parsing becomes one of utmost importance for Ur/Web, as strings are the preferred interchange format for complex structures.
        
        The logic and meaning of this is unclear as strings aren't a basic type in C -- strings are pointers to a character array. However, what you can work around by using strings here is the need to define the memory layout of the more complex structures.
    - id: 3736
      author: Josef Svenningsson
      date: "2012-05-16 05:13:19"
      content: "What did you build in the end? And how did these languages help you in building this thing?"
    - id: 3737
      author: Edward Z. Yang
      date: "2012-05-16 12:46:08"
      content: |
        Anonymous: What is meant is that a language is more likely to support strings than arbitrary arrays of pointers (yes, strings are just pointers to character arrays, but for better or worse they do tend to get special treatment.)
        
        Josef: I promise I'll talk about it some time in the near future! But for now, "theorem prover that you can interact with using your browser" is a reasonable approximation.
    - id: 3738
      author: Rick Minerich
      date: "2012-05-16 21:31:44"
      content: "Any chance you might be sharing your code?  I'd love to see how it all looks."
    - id: 3784
      author: Chris Double
      date: "2012-05-27 16:38:34"
      content: "I took a similar approach with Ur/Web's FFI in a project of mine. I used ATS (A research language for safe systems programming) to implement the FFI code and ensure I correctly handled the requirements of the Ur/Web API. It worked well."
    - id: 3785
      author: Edward Z. Yang
      date: "2012-05-27 21:40:13"
      content: |
        Rick: https://github.com/ezyang/logitext
        
        Chris: Cool! Did you publish your code?
    - id: 11535
      author: Drup
      date: "2014-12-25 23:56:49"
      content: |
        Can I ask why you didn't do Coq (which is written in OCaml) + OCaml + js_of_ocaml/ocsigen ? 
        
        You wouldn't have any FFI and js_of_ocaml is mature enough.
    - id: 11538
      author: Edward Z. Yang
      date: "2014-12-26 00:12:09"
      content: |
        Drup: There were a few reasons.
        
        Why Ur/Web? This was my MIT senior project, and since my advisor for it at the time was Adam Chlipala (who wrote Ur/Web), it seemed like a pretty fun way to get using Ur/Web and use it to build a real application.
        
        Why Haskell? Well, I like Haskell more than I like OCaml (yes, I've programmed in both). OK, but sometimes there is a good reason to pick a language based on what system you want to integrate it with. But I don't know of any projects which depend on the OCaml Coq library proper, which is a sure recipe for it to be less stable than the proof communication interface (which interfaces with Proof General, which is independent enough to be decoupled). So, given the choice to use an undocumented, possibly changing API, or an undocumented but static interchange format, it seemed obvious to me which one to pick.
    - id: 20962
      author: DBM
      date: "2016-07-16 08:58:09"
      content: |
        I salute your efforts by way of having tried out your interactive page on First Order Logic. As an Astrophysicist, this realm was antipodal to my knowledge domain, and I very much appreciated being able to learn so quickly about an otherwise opaque topic (opaque to me!). 
        
        And then I discovered the downloadable textbook, which was also very delightful... until... I read the preface and ran into the hitch that Coq 8.4 was required, and that the text is incompatible with the new version 8.5. Going over to the Coq website I found only Coq 8.5, and no apparent links to Coq 8.4. Deeper Googling finally gave me access to Coq 8.4. So, for now, it seems I can fully enjoy the new textbook.
        
        But this points out a basic fallacy, I believe, in the premise of provably correct systems. The components may well be provably correct, but invariably those components rely on an underlying system that isn't so well proven. What happens, for example, when it becomes impossible to find Coq 8.4? And what happens when the inevitable evolution of the underlying OS renders the old code unusable? So the wider system is still fallible and faces becoming inert.
        
        I'm sure this isn't lost on the research community, and you must be, perhaps secretly, sweating out these consequences.
---
