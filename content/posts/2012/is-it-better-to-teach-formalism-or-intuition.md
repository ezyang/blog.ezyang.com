---
title: "Is it better to teach formalism or intuition?"
date: 2012-03-18 16:51:31
slug: is-it-better-to-teach-formalism-or-intuition
categories: [Teaching]
comments:
    - id: 3566
      author: Anonymous
      date: "2012-03-18 17:26:57"
      content: "What equipment and software do you use to take notes?"
    - id: 3567
      author: Edward Z. Yang
      date: "2012-03-18 18:16:38"
      content: "Xournal: http://blog.ezyang.com/2010/04/diagramming-in-xournal-and-gimp/"
    - id: 3570
      author: Derek Elkins
      date: "2012-03-18 23:47:00"
      content: |
        To start, I completely agree with the main premise.  It is something I've felt strongly about for over a decade.  It is pretty easy to argue why intuition alone is not enough.  On the other hand, formalism alone is inadequate for reasons beyond its rather poor pedagogy.  It is simply not the case that a formalism has all the information.  Mathematicians spend at least as much time making definitions as deriving results.  While in one sense a definition cannot be wrong, it certainly can be bad.  You have to understand what you are attempting to model to make and judge definitions, and this is outside of the formalism.  Formalisms are not immutable.  Lakatos touches on this in "Proofs and Refutations" which is an enjoyable read in and of itself.
        
        Possibly the thing I find most valuable in addition to formal definitions that may be put into the bucket of intuition but isn't really a matter of intuition is describing the motivation for the definitions and calculations.  Probably the most value part of that is it will usually make the math much more engaging.  It also helps align and organize any intuitions.  This is a nice thing about early/original work; the "mathematicians" then tended to have very concrete motivations for what they were doing.  The math was a means to an end.
        
        Another take on this is the connection between mathematics and intuition.  Núñez and Lakoff present a philosophy of mathematics in "Where Mathematics Comes From" that is very much in line with my personal philosophy of mathematics and supports the view that formalisms do not stand on their own.
    - id: 3577
      author: Anonymous
      date: "2012-03-19 20:01:26"
      content: "I think their relationship is almost the opposite: intuition is the object under study, whereas formalism is used as a language to convey such intuition accurately (compared to natural languages). Unfortunately people forget their original purposes over time, overemphasize formalism and create overly complicated formulations."
    - id: 4695
      author: Nathan Collins
      date: "2012-11-07 04:47:42"
      content: |
        Thanks for referencing the Thurston essay, it was really interesting.
        
        Re combining intuition and formalism: I think Sipser's intro computability book is good in this respect, with the "proof ideas" before the proofs.  I wish that style was more common.
---
...
![image](/img/intuition-formalism.png)
