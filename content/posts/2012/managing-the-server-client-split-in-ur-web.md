---
title: "Managing the server/client split in Ur/Web"
date: 2012-07-25 01:17:14
slug: managing-the-server-client-split-in-ur-web
categories: [Programming Languages]
comments:
    - id: 3880
      author: Sharkey
      date: "2012-07-25 16:47:08"
      content: |
        There's a neat paper by the Jif group at Cornell with similar ideas: http://www.cs.cornell.edu/jif/swift/
        
        Swift does automatic partitioning of Java code into client/server domains based on annotations (ie, certain data can only live on the server, others only on the client, and some are free to "float").
    - id: 3883
      author: Tim
      date: "2012-07-26 01:26:03"
      content: "This is a very lucid explanation, thank you.  I generally tend to follow guideline #4 when using Ur/Web, although I previously wondered how to dictate code as specifically client or server.  The active and rpc tags will be of great use to me, since I want to write code that uses a great deal of message passing (eg. channel/send only are allowed on server, recv only is allowed on client)."
    - id: 11515
      author: JonJon
      date: "2014-12-25 14:40:52"
      content: "Nodejs seems to have taken that holy grail role quite well so far.  I can't see this Ur/Web thing make any inroad outside the academic circle with a website that looks like it was built in 1995."
---
