...
date: 2012-07-20 11:42:13
slug: secure-multiparty-bitcoin-anonymization
categories: [Cryptography]
comments:
    - id: 3866
      author: Anonymous
      date: "2012-07-20 16:40:42"
      content: "you forgot a \" at the end of your abstract statement."
    - id: 3867
      author: Anonymous
      date: "2012-07-20 18:22:00"
      content: "Your conclusion suggests that third party wallets are unnecessary because you purport to solve anonymization problems via this mixing protocol.  This statement is based on the assumption that third party wallets are only providing services related to these problems.  This assumption is certifiably false.  To the average bitcoin user, the two most important functions provided by third party wallets today seem to be the capacity for exchange with conventional currencies, and the capacity for instantaneous settlement through hosted / pre-approved funds."
    - id: 3868
      author: Anonymous
      date: "2012-07-20 18:23:10"
      content: "PS. Please join the mailing list at http://ifex-project.org/ and share your thoughts."
    - id: 3873
      author: Edward Z. Yang
      date: "2012-07-23 01:57:17"
      content: "Yes, it is true. However, that doesn't change the fact that one should avoid using third party wallets whenever possible."
    - id: 3874
      author: Anonymous
      date: "2012-07-23 05:25:43"
      content: |
        "Once Alice has successfully carried out a mixing, she flips a coin (which comes up heads with probability 1/m). If the coin comes up heads, she waits for another mixing. The number of mixing transactions she is expected to perform is m..."
        
        I think you mean "which comes up *tails* with probability 1/m" here.
    - id: 3875
      author: Edward Z. Yang
      date: "2012-07-23 11:38:31"
      content: "Thanks, fixed."
    - id: 6201
      author: Greg Maxwell
      date: "2013-08-29 20:51:38"
      content: "Are you aware of an actually available implementation of multiparty computation which is secure under a model where the attacker is active and which has a working comparison operator?  (e.g. not just a semi-honest model)"
    - id: 6233
      author: Edward Z. Yang
      date: "2013-09-13 23:23:50"
      content: "My understanding is the most an attacker can do there (assuming they aren't mounting a Sybil attack) is DoS the computation."
    - id: 6263
      author: Randall Pander
      date: "2013-10-10 14:38:15"
      content: |
        You should take a look at http://bitcoinbath.com
        
        They have some awesome solutions for anonymizing the history of your bitcoins.
    - id: 6299
      author: sd
      date: "2013-11-18 01:43:22"
      content: sad
---
