---
title: "Modelling IO: MonadIO and beyond"
date: 2012-01-24 13:31:06
slug: modelling-io
categories: [Haskell]
comments:
    - id: 3364
      author: John Millikin
      date: "2012-01-24 17:16:48"
      content: |
        ...
        Perhaps I'm misunderstanding this paragraph, but I do not see any connection between 'undefined' and asynchronous exceptions.
        
        'undefined' is 'error', which is 'throwIO', which throws a synchronous exception. The exception comes from a known location, at a specific time relative to the rest of the computation. Catching synchronous exceptions requires something like 'evaluate'.
        
        An asynchronous exception is thrown by 'throwTo', and can occur anywhere at any time. They can be delayed by 'mask', but will still be thrown eventually.
        
        Proper exception handling requires handling both synchronous and asynchronous exceptions.
    - id: 3365
      author: Edward Z. Yang
      date: "2012-01-24 17:20:44"
      content: "Asynchronous exceptions subsume synchronous exceptions. We can in fact imagine an asynchronous exception as replacing some expression with an appropriate \"throw\" in its place: it just need not be marked by source code. (This is what the semantics in Asynchronous Exceptions does.) There is also the question of imprecise exceptions, but they can also be essentially thought of in the same way."
    - id: 3366
      author: Paul R
      date: "2012-01-24 18:26:00"
      content: |
        Lately we have had plenty of insightful readings and libraries about controlling exceptions in Haskell. Unfortunatly, what it seems to show is that Haskell 98 exceptions mechanism is still out of control 14 years later.
        So the question is : does haskell *really* needed exceptions at all ?  Could we envision an exception-free base in the future ?
    - id: 3367
      author: Edward Z. Yang
      date: "2012-01-24 18:38:22"
      content: "Hey Paul; it's a good question. I think the answer is yes; in particular, I think asynchronous exceptions are one of those areas where Haskell really has the opportunity to shine (pure code, after all, is the easiest to interrupt of them all.)"
    - id: 3377
      author: John Lato
      date: "2012-01-27 08:26:15"
      content: |
        Hi Edward;  I agree that asynchronous exceptions (in the sense John Millikin meant) are probably necessary in Haskell, but I'm not convinced that the broader theoretical definition of async exceptions is necessary.
        
        In particular, I think a subset of asynchronous exceptions that excludes synchronous exceptions may be the best fit for Haskell.
    - id: 3378
      author: Edward Z. Yang
      date: "2012-01-27 10:37:01"
      content: "John Lato: Unfortunately, that doesn't mean anything to me! It seems to me that if I have asynchronous exceptions, I *must* admit synchronous exceptions (for example, consider interruptible operations like takeMVar, or even a thread throwing an exception at itself!)"
---
