...
date: 2011-04-01 09:00:44
slug: hoopl-guided-tour-base-system
categories: [Hoopl]
comments:
    - id: 1985
      author: illissius
      date: "2011-04-01 14:19:39"
      content: "Awesome, thanks. Just a few days ago I was skimming the hoopl API just to get an idea of what's in it (it's pretty big!), and have the papers saved for when I have more time (which probably isn't going to be for another month and a half)."
    - id: 1989
      author: Sam Martin
      date: "2011-04-04 11:13:15"
      content: "Yeah, thanks. This is just what I could do with to help unpick how to use Hoopl in practice."
    - id: 2002
      author: zoid
      date: "2011-04-08 12:58:03"
      content: "What is the correct repo for Hoopl these days? The one listed doesn't work, and the last version from Hackage seems outdated."
    - id: 2003
      author: Edward Z. Yang
      date: "2011-04-08 13:01:17"
      content: "Hmm, that's less than ideal. Try http://ghc.cs.tufts.edu/hoopl/hoopl.git/  instead."
    - id: 2007
      author: zoid
      date: "2011-04-09 06:15:04"
      content: |
        what about http://ghc.cs.tufts.edu/hoopl/ ? It lists
        
        git://code.eecs.tufts.edu/hoopl/hoopl.git and the repo is working
---
...
![image](/img/hoopl-base-system/source.png)
...
![image](/img/hoopl-base-system/block.png)
...
![image](/img/hoopl-base-system/closed-combining.png)
...
![image](/img/hoopl-base-system/combining.png)
