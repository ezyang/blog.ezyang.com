---
title: "Killer mutants attack (mutation gone wrong)"
date: 2011-03-09 09:00:46
slug: killer-mutants-attack-mutation-gone-wrong
categories: [Computer Science, Haskell, Software Engineering]
comments:
    - id: 1916
      author: Robert Massaioli
      date: "2011-03-13 23:41:34"
      content: Agreed Mutation sucks in all regards. Just writing some Java now and if it was not for the fact that I need some better performance then everything would be immutable.
    - id: 1922
      author: Behrang
      date: "2011-03-15 07:06:53"
      content: |
    ...
    - id: 1923
      author: Behrang
      date: "2011-03-15 07:08:24"
      content: "Plus, in Java programs the convention is to start variables with a lower case character."
    - id: 1925
      author: Achilleas Margaritis
      date: "2011-03-15 07:22:13"
      content: "As if the same logical mistake cannot be programmed by Haskell. You people are amazing. Haskell is the new Religion, isn't it?"
    - id: 1928
      author: Greg Young
      date: "2011-03-15 12:05:33"
      content: |
    ...
    - id: 1929
      author: ryaner
      date: "2011-03-15 16:18:38"
      content: "Indeed it is just a problem of bad code.. The point of the post I think is that if you are working with a language like Haskell, this sort of bad code is harder to write.. because of purity, the type system helping you and all."
    - id: 1940
      author: "who?"
      date: "2011-03-18 16:42:12"
      content: |
