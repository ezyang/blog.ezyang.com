---
title: "Mailbox: Advice for a sup first-timer"
date: 2011-04-16 13:48:54
slug: mailbox-advice-for-a-sup-first-timer
categories: [Mailbox, Toolbox]
comments:
    - id: 2069
      author: Anonymous
      date: "2011-04-18 10:50:20"
      content: "It's nice to hear that other Haskellers are using sup.  I use gmail for my main email, but I used to use sup to manage older email accounts.  Unfortunately a year or so ago sup stopped working (I used the packages on arch linux) and I've never been able to get it running again.  I really like sup though...when it works."
    - id: 10677
      author: vida
      date: "2014-12-05 03:10:55"
      content: فیاتر شکن
---
