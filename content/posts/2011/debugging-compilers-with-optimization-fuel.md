...
date: 2011-06-27 09:00:49
slug: debugging-compilers-with-optimization-fuel
categories: [Hoopl]
comments:
    - id: 2742
      author: John Regehr
      date: "2011-06-27 12:12:44"
      content: |
    ...
    - id: 2748
      author: nominolo
      date: "2011-06-28 09:58:58"
      content: "OK, I may be mistaken.  I thought I had seen it in the source code before the new code gen was merged (some time in 2008, I believe).  Looking through the history, though, it looks like I was wrong."
    - id: 2750
      author: Terry A. Davis
      date: "2011-06-28 20:25:21"
      content: |
    ...
    - id: 2813
      author: Edward Z. Yang
      date: "2011-07-18 19:02:17"
      content: "Yeah. I think it would not be too difficult to add this feature to our test drivers, but I'm not really sure how I would put it into GHC itself (our options passing machinery is not exactly modular, though you could probably make it work?)"
---
