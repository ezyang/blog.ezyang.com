---
title: "Android 2.x Sensor Simulator"
date: 2011-02-11 09:00:16
slug: android-2-x-sensor-simulator
categories: [Toolbox]
comments:
    - id: 1909
      author: Joop
      date: "2011-03-10 09:38:14"
      content: "Hi, thanks for this post. How can I compile the project, it seems some classes are missing (org.openintents.sensorsimulator.hardware.Sensor, SensorEvent, etc)."
    - id: 1910
      author: Edward Z. Yang
      date: "2011-03-10 21:55:19"
      content: "Yeah; it's not too surprising that SensorSimulatorSettings doesn't compile anymore. Just copy the .db and .hardware packages into your project. I should write up more detailed usage instructions."
---
