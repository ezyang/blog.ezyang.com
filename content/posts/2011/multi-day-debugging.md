---
title: "Multi-day debugging"
date: 2011-02-25 09:00:51
slug: multi-day-debugging
categories: [GHC, Software Engineering]
comments:
    - id: 1809
      author: Thomas
      date: "2011-02-25 14:54:24"
      content: "Very nice work and write-up!  Tiny nitpick: STG = Spineless Tagless G-machine (not \"Stackless\")."
    - id: 1810
      author: Edward Z. Yang
      date: "2011-02-25 16:21:47"
      content: "Thanks! Fixed."
    - id: 1813
      author: solrize
      date: "2011-02-25 23:28:41"
      content: "Very awesome debugging work, at the same time scary because of how it conflicts with the proverb that once Haskell programs type-check, they rarely have complicated bugs.  I wonder whether the new codegen uses (or could benefit from) recent extensions to the GHC type system, sort of like the way Darcs reportedly benefitted from use of GADT's."
    - id: 1815
      author: Thomas
      date: "2011-02-26 06:15:19"
      content: |
        @solrize: Hoopl uses GADTs and type functions (which can be very annoying at times), but the C-- intermediate representation doesn't.
        
        Based on the kinds of bugs, only few of them could have been caught by the type checker.  E.g., a mismatch between a C primitive and the codegen cannot be caught by types alone.  The registers bug may have been catchable by marking fake registers somehow.
        
        The main problem is that you have to encode invariants of imperative code into your intermediate representation.  It could be an interesting research project, though.  (In fact CompCert does something like that using Coq.)
    - id: 1816
      author: Edward Z. Yang
      date: "2011-02-26 06:29:59"
      content: "solrize: Interestingly enough, the new code generator does use some pretty advanced type system features to cover some invariants (e.g. the open-closed GADT encoding to rule out incorrect program transformations.) It would have been nice, however, if tagging was a statically checked deal... but that's C--, not Haskell. :-)"
    - id: 1818
      author: Anonymous
      date: "2011-02-26 11:57:40"
      content: "Can you elaborate on the go-back-in-time trick?"
    - id: 1820
      author: Edward Z. Yang
      date: "2011-02-26 13:11:31"
      content: "It's described in http://hackage.haskell.org/trac/ghc/wiki/Debugging/CompiledCode under the section \"Going back in time\"."
    - id: 1822
      author: Anonymous
      date: "2011-02-26 14:05:51"
      content: "haha, I see, I have used similar trick, but didn't know about the GDB commands so I was using a local variable to count the break points in my C++ code..."
---
...
- The GHC [.gdbinit file](http://hackage.haskell.org/trac/ghc/attachment/wiki/Debugging/CompiledCode/gdbinit) is magical; I don’t know where I’d be without it, and I’m probably only using 20% of its macros at this point. `disas` is your friend, as is `pstk` and `pmem`. I can’t describe how many times I’ve used the go-back-in-time trick.
