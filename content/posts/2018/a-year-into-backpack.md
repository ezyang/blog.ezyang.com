---
title: "A year into Backpack"
date: 2018-07-14 19:34:16
slug: a-year-into-backpack
categories: [Backpack]
---
...
- [\#15138](https://ghc.haskell.org/trac/ghc/ticket/15138): Backpack will soon support <span class="title-ref">data T : Nat</span> signatures, which can be instantiated with <span class="title-ref">type T = 5</span>. Thank you Piyush Kurur for diagnosing the bug and writing a patch to fix this.
