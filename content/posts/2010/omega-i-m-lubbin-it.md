---
title: "ω: I’m lubbin’ it"
date: 2010-12-15 09:00:14
slug: omega-i-m-lubbin-it
categories: [Denotational Semantics, Haskell]
comments:
    - id: 1657
      author: Mathnerd314
      date: "2010-12-15 23:12:32"
      content: "If you have greater-than, you can easily implement less-than, and thus get inequality as the lub of the two. Or am I missing something?"
    - id: 1658
      author: Edward Z. Yang
      date: "2010-12-16 02:31:26"
      content: "Yeah, that was wrong. It's been fixed."
    - id: 2301
      author: Michael
      date: "2011-05-02 16:44:06"
      content: "I'm having trouble making the leap from \"the function is not monotonic\", which is clear, to \"Thus, it must not be computable.\"  Can you elaborate?"
    - id: 2304
      author: Edward Z. Yang
      date: "2011-05-02 19:15:56"
      content: "Monotonicity and computability are developed in a previous post: http://blog.ezyang.com/2010/12/gin-and-monotonic/ ; check the middle bits."
---
...
![image](/img/omega/conversation-timeline.png)
...
![image](/img/omega/subtraction.png)
