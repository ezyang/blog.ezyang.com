---
title: "Towards platform-agnostic interruptibility"
date: 2010-09-10 09:00:47
slug: towards-platform-agnostic-interruptibility
categories: [C, GHC, Haskell]
comments:
    - id: 1141
      author: Anonymous
      date: "2010-09-11 04:50:18"
      content: Asynchronous exceptions are a usual path to madness... they were in Java but caused so many problems they were removed.. there were some proposals to put them in Python but it looked like they would cause a big mess.. maybe Haskell can deal with them more cleanly.  Some formal analysis beforehand would be nice.
    - id: 1145
      author: Simon Marlow
      date: "2010-09-13 04:55:00"
      content: "Re Anonymous: Asynchronous exceptions in Haskell are actually quite sensible.  We wrote a paper about it a while back: http://www.haskell.org/~simonmar/papers/async.pdf"
---
