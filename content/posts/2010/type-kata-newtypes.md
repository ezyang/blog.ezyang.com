---
title: "Type Kata: Distinguishing different data with the same underlying representation"
date: 2010-08-23 09:00:36
slug: type-kata-newtypes
categories: [Type Kata]
comments:
    - id: 1072
      author: zygoloid
      date: "2010-08-23 09:46:47"
      content: |
        Erratum: Several of your ByteString newtypes are missing constructor names.
        
        Also, are you endorsing the usage of contexts with newtypes? These seem to add very little, and have been proposed for removal in Haskell' even. It seems reasonable to me to allow 
        
        <code>isEmpty :: EndianByteString e -&gt; Bool</code>
        
        ... without the Endianness e constraint which the newtype context would require.
    - id: 1074
      author: Edward Z. Yang
      date: "2010-08-23 12:06:50"
      content: "Fixed the ByteString newtypes. It looks like I also have misunderstood the inference rules with respect to newtype contexts, so I’ve removed the contexts."
    - id: 1075
      author: Alessandro Stamatto
      date: "2010-08-23 13:24:02"
      content: "Great post for a newbie in Haskell like me. The examples were very interesting!"
    - id: 1076
      author: Simon Michael
      date: "2010-08-23 13:42:16"
      content: "Timely! I was just thinking about this for filepath/argument strings and file content strings on unix. You lost me around the bytestring example (NFC ?), but the gist is clear."
    - id: 1077
      author: wren ng thornton
      date: "2010-08-23 20:50:46"
      content: "I'm glad there are other folks who love newtypes as much as me. For all that Haskell's type system is a masterpiece, I think newtypes are one of the more profound innovations. Countless, countless bugs can be eliminated with them. It's a shame Habit got rid of them; I should talk to Mark about that..."
---
