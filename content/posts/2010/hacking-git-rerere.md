---
title: "Hacking git-rerere"
date: 2010-01-22 12:00:31
slug: hacking-git-rerere
categories: [Git, Hack]
comments:
    - id: 60
      author: andersk
      date: "2010-01-29 00:11:08"
      content: "Why does that mean there isn’t a race condition?  If two processes write the same contents to the same file at the same time, there’s nothing to stop the file from getting a jumbled mix of the two copies of the desired contents."
    - id: 34764
      author: Anonymous
      date: "2025-02-19 15:59:51"
      content: Hi
---
