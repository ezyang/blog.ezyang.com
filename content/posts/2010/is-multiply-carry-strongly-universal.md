---
title: "Is multiply-carry strongly universal?"
date: 2010-11-22 09:00:33
slug: is-multiply-carry-strongly-universal
...
\$h\_{a,b}(x) = (ax + b \mod p) \mod n\$

</div>

given that *p ≥ m* is prime and \$a,b \in {0, 1, \cdots, p-1}\$. Except, uh, no one actually uses a modulus in practice. Here’s one example from [Cormode’s implementation](http://www.cs.rutgers.edu/~muthu/massdal-code-index.html):
