---
title: "System.Posix.Redirect"
date: 2010-07-19 09:00:28
slug: system-posix-redirect
categories: [Hack, Haskell]
comments:
    - id: 704
      author: Jonas
      date: "2010-07-19 12:04:10"
      content: "And the weekly useless-use-of-cat award goes toooooo... :)"
    - id: 705
      author: Edward Z. Yang
      date: "2010-07-19 12:55:11"
      content: "Unix program modularity! Everything must be stdin or stdout! No compromises! :-)"
    - id: 708
      author: Thomas
      date: "2010-07-20 07:48:17"
      content: "That's accomplishing the same as this, no?  http://nominolo.blogspot.com/2010/04/haskell-tip-redirect-stdout-in-haskell.html"
    - id: 712
      author: Edward Z. Yang
      date: "2010-07-20 13:05:49"
      content: "Close but not quite. The main problem with that code is that it doesn't flush any buffers, so if you had any output before you switched (either in the Haskell or C side) it will accidentally get flushed to the new file descriptor."
---
