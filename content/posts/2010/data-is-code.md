---
title: "Data is Code"
date: 2010-09-22 09:00:38
slug: data-is-code
categories: [Compilers, Haskell]
comments:
    - id: 1198
      author: Johan
      date: "2010-09-23 17:01:15"
      content: |
        Surely "The odds that the first ball is red" is 1/2 while...
        "The odds that any of the two balls are red" is 2/3
    - id: 1199
      author: Corrie
      date: "2010-09-23 17:13:40"
      content: |
        @Johan Well, this is an interesting one.
        
        There is a situation where you only have one test, namely where you are handed a red or a blue ball, and then you have to give the odds on the ball being red. The answer is 1/2.
        
        But when there are two tests, and when you know the second ball is red, and you want to know what the odds that the first ball was also red, the answer is not 2/3. It is 1/2 * 1/2 = 1/4.
    - id: 1200
      author: Johan
      date: "2010-09-23 17:26:07"
      content: "@Corrie Thanks for clearing that up. I was wanting to point out the ambiguity of the wording in the article. Your wording is of course clear."
    - id: 1202
      author: Edward Z. Yang
      date: "2010-09-24 00:30:00"
      content: "Johan, I'm curious to know precisely what you find ambiguous about the original wording."
---
