---
title: "Type manipulation: Tricks of the trade"
date: 2010-02-19 12:00:56
slug: type-manipulation-tricks-of-the-trade
categories: [Haskell]
comments:
    - id: 176
      author: roy_hu
      date: "2010-03-13 04:30:08"
      content: "Great post, and very thought provoking. Most of the equations are solved by Hindley-Milner-style type unification. The type inference of fmap fmap fmap is a bit magical to me. How exactly does the compiler solve f a1 == (c1 -&gt; c2) -&gt; h c1 -&gt; h c2 ? I don't think it's because the compiler has some built-in knowledge of functors, because you can define a new class Functor' and the type is inferenced the same way. Is there a general theory behind \"higher-order type inference\"?"
    - id: 183
      author: Edward Z. Yang
      date: "2010-03-14 17:14:14"
      content: |
        As zygoloid on #haskell points out, this inference is completely normal once you stop treating -> as infix:
        ...
        So <code>f = (->) (c1 -> c2), and a1 = (h c1 -> h c2)</code>
    - id: 4891
      author: Anonymous
      date: "2012-11-23 06:13:42"
      content: i am not clear in your notes
---
