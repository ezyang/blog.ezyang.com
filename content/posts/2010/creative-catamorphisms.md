---
title: "Creative catamorphisms"
date: 2010-04-23 09:00:57
slug: creative-catamorphisms
categories: [Haskell, Programming]
comments:
    - id: 342
      author: Edward Kmett
      date: "2010-04-23 10:18:39"
      content: |
        Guy gave a similar talk at NEPLS a while back, which is what actually kickstarted my thinking about monoidal parsing. 
        
        Up until that point I'd been using monoids and groups to define traversals over distributed data structures, but the records there were much larger than the single characters involved in parsing problems. ;)
---
...
![image](http://upload.wikimedia.org/wikipedia/commons/3/3e/Right-fold-transformation.png)

![image](http://upload.wikimedia.org/wikipedia/commons/5/5a/Left-fold-transformation.png)
