---
title: "Static Analysis for everyday (not-PhD) man"
date: 2010-06-09 09:00:48
slug: static-analysis-mozilla
categories: [Galois Tech Talk, Programming]
comments:
    - id: 514
      author: Anonymous
      date: "2010-06-09 13:13:15"
      content: "SIPB?"
    - id: 515
      author: Edward Z. Yang
      date: "2010-06-09 13:18:36"
      content: "http://sipb.mit.edu/ ; I've added a link in the text."
    - id: 516
      author: "Taras&#8217; Blog &raquo; Galois talk"
      date: "2010-06-09 14:08:54"
      content: "[...] Z. Yang did an excellent write-up on the [...]"
    - id: 518
      author: about ten years late
      date: "2010-06-09 20:22:20"
      content: |
        Software Emancipation Technology's ParaSET/Discover products did this about 15 years ago using very similar technology 
        (full build process, hacked gcc, special database, special programming language for ASTs).  It is a shame that that product didn't succeed.
    - id: 519
      author: about ten years late
      date: "2010-06-09 20:23:00"
      content: "Oddly enough, now that I think about it, a significant chunk of the test suite was .... analyzing netscape"
    - id: 521
      author: Ira Baxter
      date: "2010-06-09 22:51:07"
      content: |
        There are other tools that are perfectly capable of parsing C++, building ASTs and symbol tables, walking these procedurally or using patterns, carrying out source-to-source transformations and regenerating text.  One such is DMS Software Reengineering Toolkit (http://www.semanticdesigns.com/Products/DMS/DMSToolkit.html).
        
        DMS is designed to do this for many languges, not just C++.
    - id: 522
      author: Edward Z. Yang
      date: "2010-06-09 23:54:52"
      content: "For me, if it's not open-source, it's not really interesting, which rules out a large class of the static analysis tools that you might see airplay from, such as Coverity. Of course, it may be the case that, as far as innovation goes, academic research is the first to have it, then industrial research, then industry, then open-source."
    - id: 19287
      author: About fifteen years late
      date: "2015-11-24 10:45:50"
      content: "Coverity has open-sourced Software Emancipation's Discover Suite."
---
...
![image](http://www.mozilla.com/img/tignish/template/footer-logo.png)
...
![image](/img/dxr/static-analysis.png)
