---
title: "Type kata: Controlled sharing of references"
date: 2010-08-18 09:00:51
slug: type-kata-controlled-sharing-of-references
categories: [Type Kata]
comments:
    - id: 922
      author: "Chung-chieh Shan"
      date: "2010-08-18 14:28:56"
      content: "I haven't run your code through ghc but shouldn't runDom have a rank-2 type?"
    - id: 923
      author: Edward Z. Yang
      date: "2010-08-18 14:38:54"
      content: "Yes, you're right. For some reason, I thought that the rank-2 type was only necessary to prevent types with s in them from escaping. I've fixed it."
    - id: 925
      author: anonymous
      date: "2010-08-18 17:16:49"
      content: |
        Mmmhh.... this somehow remembers me about region-based resource management by Olek:
        http://okmij.org/ftp/Haskell/regions.html
    - id: 926
      author: Edward Z. Yang
      date: "2010-08-18 17:34:46"
      content: "No, this is basically precisely what monadic regions are, minus some extra machinery that Oleg has to allow for promoting handles to different regions, etc."
---
