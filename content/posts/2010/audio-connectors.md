---
title: "Audio connectors and radios"
date: 2010-01-04 12:00:50
slug: audio-connectors
categories: [Radio]
comments:
    - id: 1936
      author: Rob H
      date: "2011-03-17 13:27:25"
      content: "I already own a VX-8R, and have used the 3.5mm stereo-headphone jack (on the side) with standard headphones, which is outstanding because it lets you listen to channel/band A and B in seperate ears.  I am trying to determine if the CT-131 adapter will allow the DIN pinout to work with PTT/MIC and also still retain the stereo sound (left/right channels split in headset)?"
    - id: 1937
      author: Edward Z. Yang
      date: "2011-03-17 13:30:56"
      content: |
        Hello Rob,
        
        I suppose I should have posted an update. The CT-131 adapter will work, and you can still use the stereo output. So what I do these days is I use the adapter just for the mic and don't bother with the earpiece.
---
