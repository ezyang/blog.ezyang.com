---
title: "Generalizing APIs"
date: 2010-08-13 09:00:54
slug: generalizing-apis
categories: [Haskell]
comments:
    - id: 894
      author: illissius
      date: "2010-08-13 10:48:58"
      content: |
    ...
    - id: 895
      ...
      date: "2010-08-13 10:57:33"
      content: "Oh man, that's awesome! I’ll have to update my post."
    - id: 896
      author: Anonymous
      date: "2010-08-13 11:02:01"
      content: |
    ...
    - id: 897
      author: Edward Z. Yang
      date: "2010-08-13 11:27:25"
      content: "Hmm, I see one possible problem: if you want to use a higher rank class constraint (for example, if you generalized a rank-2 monad), that syntax is not expressive enough. :-("
    - id: 898
      author: JCAB
      date: "2010-08-13 16:28:28"
      content: |
        --
    ...
    - id: 899
      author: Edward Z. Yang
      date: "2010-08-13 16:36:42"
      content: "Hey JCAB, you’re right. I rewrote that section, hopefully it makes more sense now."
    - id: 1345
      author: "Towards generic APIs for the open world &laquo; Developers.BlogNotions - Thoughts from Industry Experts"
      date: "2010-10-25 14:17:31"
      content: "[...] this sense subtype polymorphism is closed.  This post is inspired in part by the excellent article Generalizing APIs by Edward Z. Yang. For this post I will use Scala, my current language of choice for most of the [...]"
---
