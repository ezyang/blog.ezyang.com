---
title: "The case of the Hash Array Mapped Trie"
date: 2010-03-29 09:00:46
slug: the-case-of-the-hash-array-mapped-trie
categories: [Haskell]
comments:
    - id: 247
      author: Don Stewart
      date: "2010-03-29 10:59:06"
      content: |
        Interesting. You mention that:
        
         * you tweaked the JVM heap size
         * you added the -server flag (which tweaks GC and other settings)
        
        What RTS flags did you use, and why didn't you try that on the Haskell code too? If GC is relatively high, for example, increasing the default heap size can have a significant effect on Haskell too. Running with -prof -auto-all should also help show up any obvious problems.
    - id: 248
      author: Cale
      date: "2010-03-29 11:24:17"
      content: "You make it sound a bit too much like Map and IntMap have something to do with hashtables in the opening paragraphs with the \"This hasn't stopped people from trying\" immediately followed by a description of Map and IntMap. Of course, your following comments imply that they don't do any hashing, but it might be a little unclear to someone who doesn't know, I think."
    - id: 249
      author: Edward Z. Yang
      date: "2010-03-29 11:26:21"
      content: "Hi Don, I used +RTS -H1G -RTS to bump up Haskell's heap size as well (it speeded up accordingly). Usage of this data structure definitely resulted in a lot of time being spent in GC."
    - id: 250
      author: Edward Z. Yang
      date: "2010-03-29 11:39:58"
      content: "Hi Cale, I've updated the introductory text. Hopefully it's a bit clearer now!"
    - id: 498
      author: Alex Cruise
      date: "2010-06-06 10:03:27"
      content: |
        Does this help?
        
        http://lampsvn.epfl.ch/trac/scala/browser/scala/tags/R_2_7_7_final/src/library/scala/collection/immutable/IntMap.scala?view=markup
    - id: 499
      author: Edward Z. Yang
      date: "2010-06-06 13:08:41"
      content: "Cool! I'll have to give that a spin and report back the speed results."
    - id: 1739
      author: Daniel
      date: "2011-01-17 11:25:30"
      content: "Nice. Always fun to read your posts, and some of the comments they generate. I had not realized that Data.Map and Data.IntMap do not do hashing."
    - id: 1742
      author: "Code katas | Javouhey&#039;s Blog"
      date: "2011-01-20 22:20:52"
      content: "[...] Hash array mapped Trie [...]"
---
