---
title: "pthread_cancel on Windows"
date: 2010-09-08 09:00:27
slug: pthread-cancel-on-window
categories: [C, GHC, Haskell]
comments:
    - id: 1136
      author: Duncan
      date: "2010-09-08 11:33:41"
      content: Note that Windows does let you cancel async and sync system calls (as of Vista I think).
    - id: 1137
      author: Edward Z. Yang
      date: "2010-09-08 11:41:53"
      content: "Yes! CancelSynchronousIo(). Unfortunately, GHC’s Windows support extends a bit farther back than Vista."
    - id: 6325
      author: roger
      date: "2013-12-20 14:03:50"
      content: "So win32-pthreads did or did not act as expected here? I presume it did not?"
    - id: 6326
      author: Edward Z. Yang
      date: "2013-12-20 14:26:41"
      content: "I think it has a big honking \"not implemented\"."
---
