---
title: "Session types, subtyping and dependent types"
date: 2010-09-17 09:00:09
slug: session-types-subtyping-and-dependent-types
categories: [Haskell]
comments:
    - id: 1172
      author: sclv
      date: "2010-09-17 13:01:45"
      content: "Subtyping, including with records, can be inferred very well for the most part (e.g. OCaml). Sum-subtyping, which I think is more commonly known as union types, apparently leads to a big intractable mess fairly quickly."
    - id: 1176
      author: Edward Z. Yang
      date: "2010-09-17 20:35:25"
      content: "Subtyping union types looks like the term: Jérôme Vouillon wrote a paper on the topic."
    - id: 1177
      author: wren ng thornton
      date: "2010-09-17 21:17:54"
      content: "My masters thesis had a bunch about subtyping for finite unions. Though I was doing typed unification, so there's nothing in there about inference. I wouldn't think it'd be that hard... (Of course, you'd have do give up on the idea of having a principal MGU)"
    - id: 1178
      author: Edward Z. Yang
      date: "2010-09-17 21:22:48"
      content: "Forgive my ignorance: what's a principal MGU?"
    - id: 1183
      author: Artyom Shalkhakov
      date: "2010-09-18 02:25:21"
      content: |
        Edward, MGU is short for "most general unifier", and as I understand what wren said, you'd have to give up on the idea of having a most general type for a given term.
        
        Also, regarding session types and dependent types: it seems that you could use singleton types with GADTs to do what you want (as present in Omega by T. Sheard and ATS by H. Xi). What do you think?
        
        Here's an example in ATS:
        
        datatype DataFrame (bool) = {b:bool} DF (b) of (StreamId, bool b, Data)
        
        So to a term like DF (s, true, d) you would assign the type DataFrame (true) assuming that s:StreamId, d:Data.
    - id: 1189
      author: Edward Z. Yang
      date: "2010-09-18 12:41:24"
      content: "Hm! GADTs would definitely work quite well in this situation."
    - id: 1191
      author: Anonymous
      date: "2010-09-19 19:05:43"
      content: |
        Do you know about Oury and Swierstra's Power of Pi paper?  You might find it interesting.
        
        http://www.lri.fr/~noury/PowerPi.pdf
---
