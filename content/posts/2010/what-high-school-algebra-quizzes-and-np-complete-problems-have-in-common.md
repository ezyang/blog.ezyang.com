---
title: "What high school Algebra quizzes and NP-complete problems have in common"
date: 2010-08-16 09:00:03
slug: what-high-school-algebra-quizzes-and-np-complete-problems-have-in-common
categories: [Computer Science, Personal]
comments:
    - id: 908
      author: Andrew Pennebaker
      date: "2010-08-16 10:30:23"
      content: |
        Yes, software (unit) testing is indeed like double-checking high school math answers.
        
        However, high school math students rarely use mutation testing, a cool idea a friend introduced me to. It works by modifying the source code. If the unit tests still pass, then there must be a bug in the original code.
        
        I learned this after writing a Lisp interpreter (Horns http://code.google.com/p/horns) for which the very unit tests were buggy!
    - id: 912
      author: Alessandro Stamatto
      date: "2010-08-16 12:24:01"
      content: |
        Great post, im a Student of Computer Science. And i still have to take a class in Advanced Algorithms, i taked a peek and didn't quite understand it. But your post is giving me light =)
        
        I'm also a Haskell fan, and its good to see nice projects in it ; )
    - id: 913
      author: Edward Z. Yang
      date: "2010-08-16 12:47:26"
      content: "Andrew, mutation testing is indeed an interesting way of verifying unit tests: I’d heard about it but not applied any automation to it (I regularly manually break code in order to test that my unit tests are working.) One of the primary difficulties with automating this process is introducing interesting mutations, that is, mutations that are actually likely to show that your test suite is wrong."
---
