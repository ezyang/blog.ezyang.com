---
title: "The Gateway Drug to Type Programming"
date: 2010-08-06 09:00:14
slug: the-gateway-drug-to-type-programming
categories: [Haskell]
comments:
    - id: 845
      author: wren ng thornton
      date: "2010-08-06 13:47:21"
      content: |
        <blockquote>“If you have to sacrifice some static analysis for a simpler type system, do it. Things like type level numbers are not worth it.”</blockquote>
        
        Interesting.
        
        Dependent types are something close to the limit case for moving invariants into the type system. Unfortunately, you often end up spending more time programming those types than actually doing work (both in the sense of value-level programming, and in the literal sense of doing your job instead of making the types just a little prettier). This is the bane of dependently typed programming and one of the reasons it hasn't become more popular than it is. It's interesting to see where someplace like Galois has decided to draw the line.
    - id: 847
      author: Edward Z. Yang
      date: "2010-08-06 15:33:45"
      content: "Very true. Although, I would characterize Galois' philosophy as having many lines: generally you want to put in a large amount of effort into formal methods for a small kernel of functionality, and less effort into the periphery. So something like Agda in Haskell would still be useful to us, but we wouldn't use it all the time: only when deemed necessary."
    - id: 859
      author: Erik de Castro Lopo
      date: "2010-08-07 19:48:59"
      content: "You mention that its possible to statically enforce correct resource usage. Do you have a link or an example? I've been looking for this for a while."
    - id: 863
      author: Edward Z. Yang
      date: "2010-08-08 06:31:14"
      content: "Yes! The name of the technique is \"light-weight monadic regions\", and you can do something really really simple with just rank-2 types."
---
