---
title: "Defining “Haskelly”"
date: 2010-08-30 09:00:05
slug: defining-haskelly
categories: [Haskell]
comments:
    - id: 1095
      author: Jake McArthur
      date: "2010-08-30 10:56:09"
      content: |
        This is an issue that takes up a lot of my time when dealing with FFI bindings. As a hobby game developer, OpenGL plagues me the most.
        
        I try to take it a step beyond Haskelly. I try to come up with an explicit denotational semantics for my interfaces. This makes it even harder for me, but I believe the result, if it is ever completed, is even more valuable.
---
