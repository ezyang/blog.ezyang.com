---
title: "Tension of patch and tree version control"
date: 2010-09-20 09:00:06
slug: tension-of-patch-and-tree-version-control
categories: [Git, Toolbox]
comments:
    - id: 1192
      author: Alessandro Stamatto
      date: "2010-09-21 14:14:10"
      content: "Great post! I wish Darcs good luck, in their quest of improvement."
    - id: 1193
      author: Eric Kow
      date: "2010-09-22 06:57:27"
      content: "This is a really nice (thoughtful) post, thanks!  I think at least a couple of Darcs developers agree that we sometimes miss having a full historical view of a Darcs repository. We've talked about it a bit on #darcs and have kicked around some ideas, eg. autotagging GHC on a daily basis, or some sort of darcs pull --reorder command (which uses the darcs reordering to make your local work look more like a fast-forward on top of the remote).  Hopefully more to come in the future."
    - id: 1194
      author: Mark Stosberg
      date: "2010-09-22 20:08:44"
      content: |
        <blockquote> there is no shorthand for “this particular repository state”; </blockquote>
        
        "darcs tag" is an easy way to create a state which you can easily refer to. I often do "darcs tag prepull" to create a tag to represent the state just before a pull. You could use a post hook preference to automate this if you'd like.
    - id: 1195
      author: Edward Z. Yang
      date: "2010-09-22 20:11:57"
      content: "Mark, that is really solid, good advice. I should get into the habit of making those tags before pulling."
---
